...
public class CreateNewRequestForUserCommand extends BaseCommandOperations implements Command {
	private static final Logger logger = Logger.getLogger(CreateNewRequestForUserCommand.class);
	private JSONArray request = null;
	private JSONArray response = null;
	private DaoFactory instance = null;
	private RequestsDao requestDao = null;
	
	public CreateNewRequestForUserCommand (JSONArray request) {
	...
	public JSONArray execute() {
		...
		if (!errorCheck(response)) {
			try {
				int requestCreated = requestDao.createNewRequestForUser(week, ratio, senderUserName, targetUserName, projectName);
